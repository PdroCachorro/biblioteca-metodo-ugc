...
# Shared closing rule for every motion prompt, so "no zoom" / "normal pace"
# is defined once instead of copy-pasted (and drifting) across 14 cards.
MOTION_LOCK_SUFFIX = (
    "No zoom in or out at any point, no dolly, no push-in or pull-back — "
    "the framing distance stays exactly the same throughout. She moves at "
    "a natural, everyday pace the whole time — no fast, exaggerated, or "
    "rushed movements."
)


def motion(action, seconds):
    return (
        f"Animate this exact photo. {action} {MOTION_LOCK_SUFFIX} "
        f"~{seconds} seconds. No on-screen text, no captions, no subtitles, no watermarks."
    )


CARDS = {
    "mirror1": {"tag": "MOVIMENTO NATURAL", "title": "Showcase completo", "tool": "Kling 3 / Veo 3", "reqs": ["model", "scene"],
        "image_prompt": "Use image reference 1 (the model) for identity and image reference 2 (the scenario photo below) for the room — she is photographing her own reflection in that exact mirror, matching its real position, framing, and ambient light. Her iPhone's camera flash is turned on, held clearly in her hand overlapping her torso in the reflection, and the flash's light is visible reflecting off the mirror glass as a small bright flare. She stands close to the mirror so her reflection fills almost the entire frame, knees to head, casual fit (fitted top, denim shorts), leaving very little background visible around her. Slight natural rotation of the hips, imperfect off-center framing like a real handheld mirror shot — not tripod-centered. Visible skin texture, no studio lighting, no beauty filter added on top of the scenario's real light. No on-screen text, no captions, no watermarks.",
        "motion_prompt": motion("She holds the phone steady with the flash lit, tilts her head slightly and touches her hair/shoulder with her free hand as she adjusts her pose, small natural repositioning of the phone angle, and settles into a serious, seductive expression by the end, no smile. Slight natural rotation of the hips, imperfect handheld mirror-shot wobble, no cuts.", "9-10")},
    "story1": {"tag": "STORYBOARD", "title": "Apenas uma cor", "tool": "Kling 3 / Veo 3", "reqs": ["model", "scene"],
        ...
        "motion_prompt": motion("She runs one hand through her hair and lets it settle back down, gives a slight confident shift of weight and turn of the shoulders, fabric of the dress moving naturally with the motion, no cuts.", "4-5")},
    "ugc_celular": {"tag": "GANCHO", "title": "Print no celular", "tool": "Kling 3 / Veo 3", "reqs": ["model", "screenshot", "scene"],
        "image_prompt": "Use image reference 1 (the model) for identity, image reference 2 (the TikTok Shop screenshot below) to display on her phone screen, and image reference 3 (the scenario photo below) for the background — place her inside that exact room, matching its real lighting, perspective, and camera height. She holds her phone up with one arm extended toward the camera so the framing captures her from the knees up, the TikTok Shop screenshot clearly readable on the phone screen, looking directly into the camera lens, not down at her own phone screen. Casual white tank top, denim shorts, natural everyday makeup, visible skin texture — no studio lighting, no beauty filter added on top of the scenario's real light. Front-facing phone-camera framing, knee-up, natural phone-camera color and grain. No on-screen text, no captions, no watermarks — the phone's own screen content is the only text element.",
        "motion_prompt": motion("The hand holding the phone stays fixed in place the entire time, never letting go, never lowering it, holding it steady in exactly the same position from start to finish, and the TikTok Shop screenshot on the phone's screen stays exactly the same static image throughout, never changing or glitching. With her other hand — the one not holding the phone — she points at the screen to highlight the product, glances back at the camera with a playful head tilt and briefly touches her collarbone, then brings that same other hand up and fully covers the entire camera lens with her palm like a wipe transition, blacking out the frame completely; the phone-holding hand never moves and the phone never floats or changes position on its own. Keep her facial expression subtle and consistent with the original photo throughout the whole clip — no exaggerated expression changes that could make her look different from the reference.", "5-6")},
    "ugc_pacote": {"tag": "TIKTOK SHOP", "title": "Segurando pacote", "tool": "Kling 3 / Veo 3", "reqs": ["model", "package", "scene"],
        ...
        "motion_prompt": motion("She holds the package at chest height with her eyes closed for a beat of anticipation, then lifts it up near her face in a brief playful motion, and settles back into a big genuine smile holding the package steady at chest height, looking at the camera.", "5-6")},
    "ugc_blusa": {"tag": "DETALHE", "title": "Segurando blusa", "tool": "Kling 3 / Veo 3", "reqs": ["model", "clothing", "scene"],
        ...
        "motion_prompt": motion("She gently sways the garment side to side while holding it up against her chest, glancing down to check the print then back up at the camera with a soft satisfied smile, no cuts.", "5-6")},
    "ugc_giro360": {"tag": "MOVIMENTO NATURAL", "title": "Giro 360°", "tool": "Kling 3 / Veo 3", "reqs": ["model", "scene"],
        "image_prompt": "Use image reference 1 (the model) for identity and image reference 2 (the scenario photo below) for the background — place her standing centered inside that exact room, matching its real lighting, perspective, and camera height, facing the camera directly and standing close to it, as if the phone is held at arm's length just a step away, close knee-to-head framing, wearing a casual halter top and denim mini skirt. Relaxed confident stance. Visible skin texture, no studio lighting, no beauty filter added on top of the scenario's real light. No on-screen text, no captions, no watermarks.",
        "motion_prompt": motion("She does a slow full 360-degree turn to show the outfit from every angle, hair and fabric moving naturally with the motion, ending back facing the camera with a big smile, no cuts.", "5-6")},
    "ugc_posefofa": {"tag": "GANCHO", "title": "Ligar a câmera e pose fofa", "tool": "Kling 3 / Veo 3", "reqs": ["model", "scene"],
        ...
        "motion_prompt": motion("As if she just turned the camera on, she gives a playful hair flip/toss with one hand, smiles warmly at the camera, then settles into a cute relaxed pose with her hands near her back pockets, no cuts.", "5-6")},
    "ugc_look": {"tag": "MOVIMENTO NATURAL", "title": "Mostrando o look", "tool": "Kling 3 / Veo 3", "reqs": ["model", "scene"],
        ...
        "motion_prompt": motion("She shifts her weight and leans slightly side to side to show off the outfit, runs a hand through her hair and tucks it back, smiling confidently at the camera throughout, no cuts.", "5-6")},
    "ugc_cta": {"tag": "CTA", "title": "CTA", "tool": "Kling 3 / Veo 3", "reqs": ["model", "scene"],
        ...
        "motion_prompt": motion("She leans in closer toward the camera with a warm genuine smile, pointing downward with a repeated beckoning finger motion as if directing viewers to a link or button below, maintaining direct eye contact throughout.", "5-6")},
    "mirror_cabelo": {"tag": "MOVIMENTO NATURAL", "title": "Cabelo e aponta pra baixo", "tool": "Kling 3 / Veo 3", "reqs": ["model", "scene"],
        "image_prompt": "Use image reference 1 (the model) for identity and image reference 2 (the scenario photo below) for the room — she is photographing her own reflection in that exact mirror, matching its real position, framing, and ambient light. Her iPhone's camera flash is turned on, held in one hand, and the flash's light is visible reflecting off the mirror glass as a bright flare/starburst. Her other hand is raised, running through her hair. She stands close to the mirror so her reflection fills almost the entire frame, knees to head, casual fit, leaving very little background visible around her. Visible skin texture, no studio lighting, no beauty filter added on top of the scenario's real light. No on-screen text, no captions, no watermarks.",
        "motion_prompt": motion("She runs her free hand through her hair, fluffing her curls, then glides that hand down along her neck and collarbone, phone with the flash lit staying steady in her other hand.", "9-10")},
    "pov_colocar": {"tag": "TIKTOK SHOP", "title": "Colocando roupa no cenário", "tool": "Seedance 2", "reqs": ["clothing", "scene"],
        ...
        "motion_prompt": motion("The hand slowly slides the sunglasses into their final position beside the garment, then smooths a small wrinkle out of the fabric, calm, deliberate top-down product-styling motion, camera positioned directly overhead.", "5-6")},
    "pov_esticar": {"tag": "DETALHE", "title": "Esticar tecido", "tool": "Seedance 2", "reqs": ["clothing", "scene"],
        ...
        "motion_prompt": motion("Both hands gently pull the garment's waistband taut to show the fabric's stretch and quality, then release it back to its relaxed shape, calm, deliberate top-down product motion, camera positioned directly overhead.", "5-6")},
    "story_cores": {"tag": "STORYBOARD", "title": "Cores diferentes", "tool": "Kling 3 / Veo 3", "reqs": ["model", "scene"],
        ...
        "motion_prompt": motion("Keeping her pose fixed, the dress color snap-transitions through 3 solid colors in rhythm — pastel yellow, then chocolate brown, then deep burgundy wine — like a quick outfit-color-swap trend edit, same exact dress design and fit each time, ending on the burgundy version.", "4-5")},
}
